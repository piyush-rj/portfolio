...
export default function Heading({ text, tooltip, onClick, isActive, onHover }: HeadingProps) {
    ...
    return (
        <div
            ...
            className={`group relative flex justify-between items-center border border-black/5 shadow-md mb-2 px-4 py-2 text-[20px] font-semibold rounded-[10px] mt-2 transition-all duration-300
